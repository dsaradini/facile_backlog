...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Project.is_archive'
        db.add_column(u'backlog_project', 'is_archive',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Project.is_archive'
        db.delete_column(u'backlog_project', 'is_archive')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserStory.code'
        db.add_column(u'backlog_userstory', 'code',
                      self.gf('django.db.models.fields.CharField')(default='temp', max_length=20),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'UserStory.code'
        db.delete_column(u'backlog_userstory', 'code')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Dashboard.show_completed'
        db.add_column(u'dashboard_dashboard', 'show_completed',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Dashboard.show_completed'
        db.delete_column(u'dashboard_dashboard', 'show_completed')
    ...
    models = {
        ...
        u'dashboard.dashboard': {
            ...
            'show_completed': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
